...
public class Messages {
    ...
    public static final String FAREWELL =
            "Ad astra abyssosque! Welcome to Nod-Krai, dominion of the Fatui.";

    // Help
    public static final String MESSAGE_VALID_COMMANDS =
    ...
    public static final String MESSAGE_TASK_ADDED =
            "It has been recorded. Try not to forget it.\n";
    public static final String MESSAGE_TASK_DELETED =
            "Disposed of. It was not worth my data storage anyway.\n";
    public static final String MESSAGE_TASK_MARKED =
            "I've noted your progress. Is that all?\n";
    public static final String MESSAGE_TASK_UNMARKED =
            "Hmph. Regressing, are we?\n";
    public static final String MESSAGE_RECURRING_TASK_ADDED =
            "A repetitive cycle... very well, I shall automate it.\n";
    public static final String MESSAGE_RECURRING_TASK_DELETED =
            "Hmm, ok. I have removed this recurring task:\n";
    ...
    public static final String ERROR_NONPOSITVE_INDEX =
            "Negative indices? Zero? Do you even understand the concept of a list?";
    public static final String ERROR_EMPTY_INDEX =
            "Am I supposed to guess which task you mean? Provide an index, now.";
    public static final String ERROR_INDEX_OUT_OF_RANGE =
    ...
    public static final String ERROR_INVALID_DEADLINE_FORMAT =
            "Your deadline command is incomplete. It requires a ' /by ' tag.";
    public static final String ERROR_EMPTY_DESCRIPTION_AND_DUEDATE =
            "You provided me with neither a description nor the due date?";
    public static final String ERROR_EMPTY_DUEDATE =
            "You provided a deadline without a duedate.";

    public static final String ERROR_INVALID_EVENT_FORMAT =
            "Your event syntax is a mess. It requires both ' /from ' and ' /to '. Try to keep up.";
    public static final String ERROR_EVENT_DATE_ORDER =
            "Time flows forward, not backward. Fix your event dates.";
    public static final String ERROR_EMPTY_EVENT_START_AND_END =
            "Hello? You are missing both the beginning and the end of your event.";
    public static final String ERROR_EMPTY_EVENT_START_DATE =
            "You've omitted the start of your event. I cannot track a 'from' that does not exist.";
    public static final String ERROR_EMPTY_EVENT_END_DATE =
            "An event with no end in mind? What are you doing. Provide a date after the '/to' tag.";

    public static final String ERROR_RECUR_TYPE =
            "I can only replicate todos, deadlines, or events. Don't test my patience threshold.";
}
